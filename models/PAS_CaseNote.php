...
/**
 * This is the model class for table "SILVER.CNT030_CASENOTE".
 *
 * The followings are the available columns in table 'SILVER.CNT030_CASENOTE':
...
class PAS_CaseNote extends MultiActiveRecord {
	...
	public function search() {
		...
		$criteria->compare('C_CN',$this->C_CN);
